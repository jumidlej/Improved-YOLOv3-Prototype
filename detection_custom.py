...
image_path   = "/home/jacq/Documentos/Datasets/pcb_pascal/images/Virtex6.jpg"
output_path = "images/test.jpg"
#video_path   = "./IMAGES/test.mp4"

yolo = Load_Yolo_model()
detect_image(yolo, image_path, output_path, input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
