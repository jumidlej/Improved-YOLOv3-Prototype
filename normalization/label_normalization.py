...
xml_path = '/home/jacq/Documentos/Datasets/pcb_pascal/labels/'
...
'''
def normalization(xml_files):
    # create a empty set
    components = set()
    for xml in xml_files:
        components = components.union(naive_normalization(xml))
...
xml_files = list_xml_files(path=xml_path)
normalization(xml_files)
